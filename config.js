...
module.exports = {
    VERSION: 'v1.0.0',
    ALIVE: process.env.ALIVE || "https://graph.org/file/7bdb2abb7d451248db067.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    RG: process.env.RG || '6289677134384-13439223088@g.us',
    BOT_INFO: process.env.BOT_INFO || 'Rexa;Skl11;0;https://graph.org/file/7bdb2abb7d451248db067.jpg;https://chat.whatsapp.com/rexashh',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Rexaaditya",
    BOT_NAME: process.env.BOT_NAME || 'Rexa',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Rexa;Raganork MD bot;https://graph.org/file/7bdb2abb7d451248db067.jpg' : process.env.AUDIO_DATA,
